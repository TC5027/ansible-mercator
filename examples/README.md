Pour reddit :
I want to share a CLI that I find of great use when dealing with large scale Ansible inventories, goal being to ease/automate parts of merge reviews and protect flexibility provided by Ansible inventories.
There is example provided to illustrate why/how to use this tool.
For the moment not all formats of inventory are supported because the Ansible Python library lacks feature for retrieving the variables defined at a given group_var level.
# Examples
...
INCORRECT LOCATION ceph_version in rack_1.yml
'''
